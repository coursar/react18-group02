...
import { combineSlices, configureStore, createAction, createReducer, createSlice } from "@reduxjs/toolkit"

const actionCreator = createAction('slice/action')
const sliceInitialState = {value: 'initial'}
...
// in separate file
const BasicRedux12ToolkitReducer = () => {
    return (
        <>
...
export default BasicRedux12ToolkitReducer
